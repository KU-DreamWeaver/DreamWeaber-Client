    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-100 flex items-center justify-center sm:bg-black/40 sm:backdrop-blur-sm"
        >
          <div className="w-full h-full sm:w-[430px] sm:h-[85vh] sm:rounded-4xl flex flex-col bg-[#faf9fe]/90 backdrop-blur-xl overflow-hidden shadow-2xl relative">
            {/* Header */}
                ...
                <section>
                  ...
                  <div className="grid grid-cols-10 gap-2 mb-3">
                    <input
                      ...
                      className="col-span-8 h-12 px-4 rounded-xl border border-gray-200 bg-white/50 focus:bg-white focus:border-[#8E2DE2] outline-none transition-all placeholder:text-gray-400"
                    />
                    <button
                      type="button"
                      onClick={handleAddKeyword}
                      className="col-span-2 h-12 rounded-xl bg-[#8E2DE2] text-white flex items-center justify-center shadow-lg shadow-purple-200 hover:bg-[#7a25c2] transition-colors"
                    >
